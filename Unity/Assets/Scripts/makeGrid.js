...
function Start () {
	...
	for(var rowX = 0; rowX < rows; rowX++){
		for(var rowZ = 0; rowZ < columns; rowZ++){
			var gridPiece : Transform = Instantiate(gridObject, Vector3((rowX * squareSize) + gridLocation.x, gridLocation.y, (rowZ * squareSize) + gridLocation.z) * 1.1, Quaternion.identity);
